...
public class PlayWithRobot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<Ruler.getPlayerArray().length;i++) {
            int temp=0;
            Log.d("sggg",String.valueOf(i));
            Log.d("samnooo",String.valueOf(Ruler.getPlayerArray()[i].getPlayerState() ));
            if (i == 0 && Ruler.getPlayerArray()[i].getPlayerState() == PlayerState.PlayerRound) {
                Log.d("tiopoo",String.valueOf(isFirst));
                break;
            }
            else if (Ruler.getPlayerArray()[i].getPlayerState() == PlayerState.PlayerRound) {
                    Log.d("ooo",String.valueOf(isFirst));
                    if (isFirst) {
                    ...
                    Log.d("sddghg",String.valueOf(i));
                    Log.d("oerq",String.valueOf(isFirst));
                }
                    else {
                        Ruler.getPlayerArray()[i].RobotShowCard();
                            Log.d("ooiiio",String.valueOf(isFirst));
//                            switch (i){
//                            case 1:
            ...
            switch (v.getId()) {
                case R.id.imageView1:
                    if (location) {
                        ...
                        image1.offsetTopAndBottom(50);
                        location = true;
                        Ruler.getHumanPlayerArray()[0].removeCardsToShow(cardID[0]);
                    }
                    break;
                ...
                case R.id.imageButton_pass:
                    Log.d("lll",String.valueOf(Ruler.getHumanPlayerArray()[0].getPlayerState()));
                    Log.d("lyyy",String.valueOf(Ruler.getPlayerArray()[1].getPlayerState()));
                    Log.d("lhh",String.valueOf(Ruler.getPlayerArray()[2].getPlayerState()));
                    Log.d("lppp",String.valueOf(Ruler.getPlayerArray()[3].getPlayerState()));
                    if(Ruler.getHumanPlayerArray()[0].getPlayerState()==PlayerState.PlayerRound){
                        Ruler.getHumanPlayerArray()[0].pass();
                        Log.d("lrrrrll",String.valueOf(Ruler.getHumanPlayerArray()[0].getPlayerState()));
                        Log.d("lqqwq1",String.valueOf(Ruler.getPlayerArray()[1].getPlayerState()));
                        Log.d("ll2",String.valueOf(Ruler.getPlayerArray()[2].getPlayerState()));
                        Log.d("ll3",String.valueOf(Ruler.getPlayerArray()[3].getPlayerState()));
